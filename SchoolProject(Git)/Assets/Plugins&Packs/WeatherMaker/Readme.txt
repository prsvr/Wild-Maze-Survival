...
- If you want clouds or sky sphere, change camera settings to clear as solid color, black (0,0,0,0). Camera set as skybox clear will render over top of clouds and sky sphere.
...
- *IMPORTANT!!!* Add ignore cameras to WeatherMakerScript (root of prefab) in the ignore cameras property. Reflection cameras, TextMesh pro camera, outline effects cameras, etc. or other special cameras can cause artifacts if not ignored.
