...
namespace DigitalRuby.WeatherMaker
{
    ...
    public class WeatherMakerSoundScript : WeatherMakerBaseScriptableObjectScript
    {
        ...
        public override void Initialize()
        {
            ...
            if (AudioSourceLoop == null && Parent != null)
            {
        ...
        public override void Update()
        {
            ...
            AudioSourceLoop.VolumeModifier = (WeatherMakerScript.Instance == null ? 1.0f : WeatherMakerScript.Instance.cachedVolumeModifier * WeatherMakerScript.Instance.AmbientVolumeModifier);
        ...
        {
            if (WeatherMakerScript.Instance != null && !Disabled && CanPlay && AudioClips != null && AudioClips.Length != 0 && (HoursOfDay.Count != 0 ||
                (WeatherMakerScript.Instance.DayNightScript != null && (int)(WeatherMakerScript.Instance.DayNightScript.TimeOfDayCategory & TimesOfDay) != 0)))
            {
                ...
                {
                    if (WeatherMakerScript.Instance.DayNightScript != null &&
                        WeatherMakerScript.Instance.DayNightScript.TimeOfDayTimespan.TotalHours >= hours.Minimum &&
                        WeatherMakerScript.Instance.DayNightScript.TimeOfDayTimespan.TotalHours <= hours.Maximum)
                    {
                        return true;
                    }
                }
