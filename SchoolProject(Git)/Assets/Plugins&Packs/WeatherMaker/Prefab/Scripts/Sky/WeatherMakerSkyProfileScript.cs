...
namespace DigitalRuby.WeatherMaker
{
    ...
    public class WeatherMakerSkyProfileScript : ScriptableObject
    {
        ...
        {
            if (material == null || WeatherMakerScript.Instance == null || WeatherMakerScript.Instance.Sun == null ||
                WeatherMakerScript.Instance.Sun.Transform == null || WeatherMakerScript.Instance.Sun.Light == null)
            {
                return;
            }
