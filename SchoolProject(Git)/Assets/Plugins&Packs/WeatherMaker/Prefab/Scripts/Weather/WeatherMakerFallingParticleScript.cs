    ...
    public class WeatherMakerFallingParticleScript : MonoBehaviour
    {
        ...
        private void CheckForIntensityChange()
        {
            ...
            else
            {
                ...
                {
                    PlayParticleSystem(ParticleSystem, BaseEmissionRate, IntensityMultiplier * ExternalIntensityMultiplier);
                }
                if (ParticleSystemSecondary != null)
                {
                    ...
                    {
                        PlayParticleSystem(ParticleSystemSecondary, BaseEmissionRateSecondary, SecondaryIntensityMultiplier * ExternalIntensityMultiplier);
                    }
                }
                if (MistParticleSystem != null)
                {
                    ...
                    {
                        PlayParticleSystem(MistParticleSystem, BaseMistEmissionRate, MistIntensityMultiplier * ExternalIntensityMultiplier);
                    }
                }
            }
        }
        ...
        {
            if (p != null && wasPlayingDictionary[p])
            {
                p.Play();
            }
        }
        ...
        protected virtual void Update()
        {
            ...
            {
                SetVolumeModifier(WeatherMakerScript.Instance.cachedVolumeModifier);
            }
        }
