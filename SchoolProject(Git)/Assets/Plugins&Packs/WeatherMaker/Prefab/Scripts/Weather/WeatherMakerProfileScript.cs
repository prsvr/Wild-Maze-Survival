...
namespace DigitalRuby.WeatherMaker
{
    ...
    {
        [Header("Animation")]
        [SingleLineClamp("Random range in seconds this profile takes to transition in/out. This will affect how long the clouds, wind, precipitation and fog take to transition.", 0f, 300.0f)]
