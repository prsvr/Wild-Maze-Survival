...
namespace DigitalRuby.WeatherMaker
{
    ...
    public class WeatherMakerScript : MonoBehaviour
    {
        ...
        public float VolumeModifier
        {
            ...
            set
            {
                VolumeModifierDictionary["WeatherMakerScript"] = volumeModifier = value;
            }
        }
        ...
        public WeatherMakerCelestialObject GetCelestialObject(Light light)
        {
            foreach (WeatherMakerCelestialObject obj in Suns)
            {
                if (obj.Light == light)
                {
                    return obj;
        ...
        private void SetGlobalShaders()
        {
            ...
            for (int i = 0; i < Moons.Length; i++)
            {
                ...
                if (moon != null && moon.Transform != null && moon.Renderer != null && moon.Light != null)
                {
        ...
        {
            if (IgnoreCameras != null && 
                (IgnoreCameras.Contains(camera) || (IgnoreReflectionProbes && camera.CachedName().IndexOf("probe", StringComparison.OrdinalIgnoreCase) >= 0)))
            {
                return;
            }
        ...
        private void CameraPostRenderWrapper(Camera camera)
        {
            if (IgnoreCameras != null &&
                (IgnoreCameras.Contains(camera) || (IgnoreReflectionProbes && camera.CachedName().IndexOf("probe", StringComparison.OrdinalIgnoreCase) >= 0)))
            {
        ...
        private void Start()
        {
            ...
            if (Application.isPlaying)
            {
                ...
                if (WeatherMakerLightManagerScript.Instance != null && LightningBoltScript != null)
                {
            ...
            Camera.onPostRender += CameraPostRenderWrapper;
        }
